        ...
        <>
            ...
            <div className="container">
                ...
                <div className="col-sm-9 content-area">
                    ...
                    {children}
                    <form action={`/realms/${import.meta.env.VITE_KEYCLOAK_REALM}/protocol/openid-connect/auth`} method="GET">
                        <input type="hidden" id="client-id" name="client_id" value="account"/>
                        <input type="hidden" id="redirect_uri" name="redirect_uri" value={`${import.meta.env.VITE_KEYCLOAK_URL}/realms/${import.meta.env.VITE_KEYCLOAK_REALM}/account?referrer=${import.meta.env.VITE_KEYCLOAK_CLIENT_ID}`}/>
                        <input type="hidden" id="response-mode" name="response_mode" value="query"/>
                        ...
                        <button type="submit" btn-danger name="submitAction" value="Delete Account">Delete Account</button>
                    </form>
                </div>
            </div>
        </>
